            ...
            <div className='programmer pt-4 pt-md-0 d-md-flex align-items-center'>
                ...
                <div className='details mt-2 mt-md-0'>
                    <div className='company d-flex'>
                        <h6 className='company m-0 text-c-dark'>{company}</h6>
                        {
                            nuew
                            &&
                            <span className='badge mx-3 rounded-4 bg-dark-cyan d-flex align-items-center justify-content-center'>
                        ...
                        }
                        {
                            featured
                            &&
                            <span className='badge rounded-4 bg-dark d-flex align-items-center justify-content-center'>
                                <b className='mt-0 text-uppercase'>featured</b>
                            </span>
                        }
                    </div>

                    <p className='position m-0 my-md-1'><b>{position}</b></p>

                    <ul className='time-posted px-0 d-flex'>
                        <li className='day text-gray'>{postedAt}</li>
                        <li className='contract mx-4 text-gray'>{contract}</li>
                        <li className='location text-gray'>{location}</li>
                    </ul>
                </div>
            </div>
